pro bin_si4_human_failure

	
	redshift_array = [5.79, 5.99, 5.98, 6.13]
    sightline = ['S0927', 'S1306', 'U0148', 'U1319']
	
	input_path = '/lustre/projects/p036_swin/alexc/completeness_test/si4/fits/'
	...
	str = {z:0.0, c_d:0.0, USER_FAILURE_1393:0.0}
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	for s = 0, n_elements(sightline) - 1 do begin	
		...
		for c = 0, n_elements(column_density_range) - 1 do begin
			...
			input_fits_name  = input_path + 'real_si4_human_acc_fail_' + cd_index_string + '.fits'
			...
			for z = 0, n_elements(redshift) - 2 do begin
				...
				sum3 = total(input_fits[index].USER_FAILURE_1393)
				
				output_fits[local_counter].z   = local_redshift
				output_fits[local_counter].c_d = column_density_range[c]
				output_fits[local_counter].USER_FAILURE_1393  = sum3/n_elements(index)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	for s = 0, n_elements(sightline) - 1 do begin	
		...
		for c = 0, n_elements(column_density_range) - 1 do begin
			...
			input_fits_name  = input_path + 'art_si4_human_acc_fail_' + cd_index_string + '.fits'
