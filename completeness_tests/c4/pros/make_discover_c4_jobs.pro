pro make_discover_c4_jobs

	shell_path = '/lustre/projects/p036_swin/alexc/completeness_test/c4/fits/shell/'
	pro_path = '/lustre/projects/p036_swin/alexc/final_files/correct_precision/completeness_tests/c4/pros/'

	SOLS = ['S0927', 'S1306', 'U0148', 'U1319']
		...
		for c = 0, n_elements(column_density_range) do begin
			...
			;	open the .sh file for writing
				openw, lun, shell_file, /get_lun
					...
					rnew_line = '.rnew '+  pro_path + 'discover_artificial_c4' 
					printf, lun, rnew_line
				
					printf, lun, ""
					printf, lun, ""

					discover_c4 = 'discover_artificial_c4, ' + string(s) + $
									' , ' + ' ' +string(c)  
					printf, lun, discover_c4
