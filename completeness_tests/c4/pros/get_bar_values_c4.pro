pro get_bar_values_c4
	...
	;	get real failure
	failure_path = '/lustre/projects/p036_swin/alexc/completeness_test/c4/fits/results'
	s = 0
	sol = sightline[s]
	...
	s = 0
	sol = sightline[s]
	cbar_fits_name = cbar_path + sol + '_c4_h_acc_cd0d1_z0d01.fits'
