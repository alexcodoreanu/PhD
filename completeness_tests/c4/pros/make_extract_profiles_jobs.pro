pro make_extract_profiles_jobs
	...
	shell_path = '/lustre/projects/p036_swin/alexc/final_files/correct_precision/completeness_tests/c4/pros/shell_files/'
	...
	for c = 0, n_elements(column_density_range) - 1 do begin
		...
		shell_file =  shell_path + 'c4_cd_' + cd_string + '.sh'
		print, shell_file
	...
	openw, lun, submit_file, /get_lun
		for c = 0, n_elements(column_density_range) - 1 do begin
			...
			shell_file = 'c4_cd_' + cd_string + '.sh'
			line =  'qsub  -q gstar -l walltime=10:55:00   ' + shell_file
			printf, lun,line
