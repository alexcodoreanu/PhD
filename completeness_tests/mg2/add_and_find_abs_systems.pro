...
pass_structure_name = "/lustre/projects/p036_swin/alexc/completeness_test/mg2/rf_" + $
...
for i = 0, n_elements(ew) - 1 do begin
	...
	sigma_3_result = find_mg2_absorbers(l, modified_spectrum, e, redshift_emission[index], 3.0)					
	...
	sigma_5_result = find_mg2_absorbers(l, modified_spectrum, e, redshift_emission[index], 5.0)					
