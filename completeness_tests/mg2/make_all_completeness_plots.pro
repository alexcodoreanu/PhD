pro make_all_completeness_plots

plot_path = '/lustre/projects/p036_swin/alexc/final_files/correct_precision/completeness_tests/mg2/completeness_plots/'
...
for local_index = 0, 3 do begin
	...
	input_fits_name = fits_path + "binned_ew_0d01_l_28A_" + batch_index + "_" + local_index_string + ".fits"
	input_fits = mrdfits(input_fits_name, 1)
	ew_values = input_fits.ew 

	for x = 0, 1 do begin
		plotname = plot_path + SOLS[local_index] + '_' + batch_index + '_pixels_' + sigma_name[x]
		print, plotname
