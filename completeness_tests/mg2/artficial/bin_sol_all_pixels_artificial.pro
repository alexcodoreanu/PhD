pro bin_sol_all_pixels_artificial
	...
	for index = 0, 3 do begin
		...
		input_name = fits_path + "binned_artificial_ew_0d01_l_28A_5_" + index_string + ".fits"
		temp_file = mrdfits(input_name, 1)
		
		output_name = fits_path + "binned_artificial_ew_0d01_l_28A_" + index_string +  "_all_pixels.fits"
		...
		for z = 1, n_elements(pixels) - 1 do begin
			...
			input_name = fits_path + "binned_artificial_ew_0d01_l_28A_" + batch_index + "_" + index_string + ".fits"
