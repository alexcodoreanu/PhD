pro bin_artificial_mg2
	...
	for z = 0, n_elements(pixels) - 1 do begin
		...
		for index = 0, 3 do begin
			...
			temp_file_name = fits_path + "artificial_" + batch_index + "_" + index_string + "_0.fits"
			temp_file = mrdfits(temp_file_name, 1)	 
			
			output_name =  fits_path + "unbinned_artificial_" + batch_index + "_" + index_string + ".fits"
			...
			for x = 1, 99 do begin
				...
				fits_file = fits_path + "artificial_" + $
