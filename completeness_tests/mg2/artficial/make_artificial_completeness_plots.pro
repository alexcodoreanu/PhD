pro make_artificial_completeness_plots
...
for local_index = 0, 3 do begin
	...
	input_fits_name = fits_path + "binned_artificial_ew_0d1_l_28A_" + local_index_string +  ".fits"
	input_fits = mrdfits(input_fits_name, 1)
	ew_values = input_fits.ew 
	
	for x = 0, 1 do begin
		plotname = plot_path + SOLS[local_index] + '_artificial' + sigma_name[x]
		print, plotname
