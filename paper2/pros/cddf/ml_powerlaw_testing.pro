Function ml_powerlaw_testing,data,completeness=completeness,logx_range=logx_range,$
...
if (n_params() lt 1) then begin
   print,'CALLING SEQUNCE:  param_est = ml_powerlaw(data,...)'
   return,-1
endif
...
if keyword_set(plot) then begin
   contour,L,alpha_list,logB_list,level=[L99,L95,L68],$
           xtitle='alpha',ytitle='logB',xs=3,ys=3
   
   contour,L,alpha_list,logB_list,level=[L99,L95,L68],$
           xtitle='alpha',ytitle='logB',xs=3,ys=3, xr = [-1.5, -0.5]
   ;; TESTING
   ;true_alpha = -2.0d
   ;true_logB  = -12.0229
