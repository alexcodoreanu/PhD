...
;
;
pro run_ml_exponential_new_mincd, path, zbin_bound_low, zbin_bound_high, ion, mincd
...
;	CDDF MLE input parameters
	...
	param_est = ml_exponential(10d^completeness3[0, *],completeness=completeness3,logx_range=logx_range,$
...
;	param_est = ml_powerlaw_testing_aug28(10d^completeness3[0, *],logx_range=logx_range,$
;                 		   	    	    alpha_range=alpha_range,logB_range=logB_range,$
;                 		   	            alpha_list=alpha_list,logB_list=logB_list,$
;                 		   	            likelihood=likelihood,plot=plot)
...
;	get total cummulative marginalised pdf for each parameter
	...
	stop
		...
		;				xr = [-3.25, -0.5], xtickv=[-3.0, -2.75, -2.5, -2.25, -2.00, -1.75, -1.50, -1.25, -1.00, -0.75], $
		;				xtickn = ['!6-3.00!N',' ','!6-2.50!N',' ', '!6-2.00!N', ' ', '!6-1.50!N', ' ', '!6-1.00!N', ' '], $
		;				xticks = 9, $
		;				yr = [-15.75, -13.5], ytickv = [-15.5, -15.25, -15.0, -14.75, -14.5, -14.25, -14.00, -13.75], $
		;				ytickn = ['!6-15.50!N',' ','!6-15.00!N',' ','!6-14.50!N',  ' ','!6-14.00!N', ' '], $
		;				yticks = 7
		;
		...
		;			    xtitle='!4a!N', ytitle='!6 log f(N0)!N', xstyle=3, ystyle=3, $
		;				charsize = 2.5, thick = 5, $
		;				xr = [-2.0, -0.75], xtickv=[ -1.75, -1.50, -1.25, -1.00], $
		;				xtickn = ['!6-1.75!N','!6-1.50!N', '!6-1.25!N', '!6-1.00!N'], $
		;				xticks = 3, $
		;				yr = [-14.5, -13.5], ytickv = [ -14.25, -14.00, -13.75 ], $
		;				ytickn = ['!6-14.25!N', '!6-14.00!N', '!6-13.75!N' ], $
		;				yticks = 2
...
;			oplot, [-5, -0.0], [best_logb, best_logb], linestyle=2
;			oplot, [best_alpha, best_alpha], [-18, -10], linestyle=2
;			xyouts, -1.985, -14.25, '!6N0=10!A13.64!N!N', charsize = 2.5, charthick=4
...
;			best_alpha_line = '!4a!N!6 = -1.32!N!9+!N !6' + alpha_error_string +'!N'
;			xyouts, -1.985, -14.35, best_alpha_line, charsize = 2.5, charthick=4
...
;			xyouts, -0.99, -13.7, '!6CIV!N',charsize = 2.5, charthick=4
;			xyouts, -1.37, -14., '!65.19 < z !N!9l!N!66.13!N',charsize = 2.5, charthick=4
;	        xyouts, -0.99, -13.6, '!6CIV!N',charsize = 2.5, charthick=4
;	        xyouts, -1.15, -13.73, '!64.33 < z !N!9l!N !65.19!N',charsize = 2.5, charthick=4
