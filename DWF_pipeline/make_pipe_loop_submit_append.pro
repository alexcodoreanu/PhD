			...
			for i = 1, 59 do begin
				...
				if i gt 9 then ccd_id = strmid(strtrim(string(i),1),0,2)
					...
					openw, lun, temp_submit_file, /get_lun
						...
						launch_line =  "/lustre/projects/p025_swin/pipes/DWF_PIPE/TEST/pipelooplaunch_appended.sh ut" + date_string + "    " + ccd_id + $
										" 504203 WCSNON_SEARCHRAD 100 "
