...
function decompress_and_move_tuesday, tar_name
		...
		;		print, 'Output file is:                     ', fits_file_name
				full_fits_file_name = new_directory_name + fits_file_name
					...
					openw, lun, shell_name, /get_lun
						...
						printf, lun, ""
						printf, lun, ""
						name_line =  '#PBS -N '+ obs_number + '_' + CCD_number
						printf, lun, name_line
						
						
						temp_output_file = new_shell_directory_name + "/" + obs_number + "_" + CCD_number + ".out"
						output_line =  "#PBS -o g2.hpc.swin.edu.au:" + temp_output_file
						printf , lun, output_line
						
						temp_error_file = new_shell_directory_name + "/" + obs_number + "_" + CCD_number + ".err"
	...
	;	now chmod the shell_scripts so that I can launch the jobs
		chmod_command = "chmod 775 " + new_shell_directory_name + "/* "
		spawn, chmod_command
	...
	;	create submit file
		...
		openw, lun, submit_file_name, /get_lun
			...
			for i = 0, n_elements(shell_jobs) - 1 do begin
				...
				submit_line = "qsub  -q sstar -l walltime=00:15:00  " +  shell_jobs[i]
