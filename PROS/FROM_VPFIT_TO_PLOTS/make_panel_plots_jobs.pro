pro make_panel_plots_jobs
	...
	plot_path = '/lustre/projects/p036_swin/alexc/final_files/correct_precision/S0927/plots/'          
	...
	;	elements holds the element id.s in the same index order as the sorted z_arr array
		...
		elements= strarr(n_elements(els))
...
for i = 0, n_elements(z_arr)-1 do begin
	...
	pro_file = pro_path + "panel_plot_" + id + ".pro"	
	openw, lun, pro_file, /get_lun
				              
			printf, lun, "pro panel_plot_" + id
			printf, lun, ""
				                                                                                                                                                                                            
			printf, lun, "	multiplot_title = 'SDSS J0927+2001'                                                                                                                                                         "
			printf, lun, "	plot_path = '/lustre/projects/p036_swin/alexc/final_files/correct_precision/S0927/plots/'                                                                                     "
			...
			printf, lun, "		elements= strarr(n_elements(els))                                                                                                                                                        "
			printf, lun, "	;	remove the white spaces from els                                                                                                                                                         "
			printf, lun, "		for i = 0, n_elements(els) - 1 do begin                                                                                                                                                  "
			printf, lun, "			elements[i] = strtrim(els[i])                                                                                                                                                        "
			printf, lun, "		endfor   
			...
			printf, lun, "  i = ", id                                                                                                                                                                            
			printf, lun, "		z_arr = redshift                                                                                                                                                                         "
			printf, lun, "		z_err = z_error                                                                                                                                                                          "
			...
			printf, lun, "		b_arr = b_array                                                                                                                                                                          "
			printf, lun, "		b_err = b_error                                                                                                                                                                          "
			printf, lun, "                                                                                                                                                                                               "
			...
			printf, lun, "		cd_arr = cd_array                                                                                                                                                                        "
			printf, lun, "		cd_err = cd_error                                                                                                                                                                        "
			printf, lun, "                                                                                                                                                                                               "
			...
			printf, lun, "                                                                                                                                                                                               "
			printf, lun, "		plotname =  plot_id + z_string + '.ps'                                                                                                                                                   "
			printf, lun, "                                                                                                                                                                                               "
			printf, lun, "                                                                                                                                                                                               "
			...
			printf, lun, "		ion_index = where(rest_lambda*(z_arr[i] + 1) gt min(lambda) + 5. and rest_lambda*(z_arr[i] + 1) lt max(lambda) - 100.0)                                                                      "
			printf, lun, "                                                                                                                                                                                               "
			printf, lun, "	;	this holds the index of the actual fit elements                                                                                                                                          "
			printf, lun, "	abs_index = where(z_arr gt  (z_arr[i] - 0.5) and z_arr lt (z_arr[i] + 0.5))                                                                                                                "
			printf, lun, "                                                                                                                                                                                               "
			...
			printf, lun, "		!p.font=0                                                                                                                                                                                "
			printf, lun, "		DEVICE, filename = plotname, /color, xsize=9, ysize=(3*(n_elements(ion_index)) + 3.), /encapsulated, /inches                                                                             "
			printf, lun, "				multiplot, [1, n_elements(ion_index)], mTitle=multiplot_title, mTitSize=1.5, mTitOffset=0, mxTitle='velocity (km/s)', $                                                          "
			printf, lun, "				mxTitSize= 1.5, mxTitOffset=1, myTitle='Normalized Flux', myTitSize=3, myTitOffset=1                                                                                         "
			printf, lun, "                                                                                                                                                                                               "
			printf, lun, "                                                                                                                                                                                               "
			...
			printf, lun, "				plot, velocity_vector, fff, psym = 10, thick = 4, charthick=3, xstyle=1, $                                                                                                      "
			printf, lun, "					  ystyle=1,  xthick = 3, ythick = 3, charsize = 1.3, xr = [-300.0, 800.0], $                                                                                                 "
			printf, lun, "					  yr = [0.0, 1.8], /nodata, font=0, YTICKS=2, YTICKV=[0, 0.5,  1]                                                                                                            "
			printf, lun, "                                                                                                                                                                                               "
			printf, lun, "				loadct, 0                                                                                                                                                                        "
			...
			printf, lun, "				xyouts, -290.0, 0.35, local_element, charsize = 1.3, charthick = 3                                                                                                               "
			printf, lun, "				xyouts, -235.0, 0.35, local_wavelength, charsize = 1.3, charthick = 3                                                                                                            "
			printf, lun, "				xyouts, -290.0, 0.10, 'redshift = ', charsize = 1.3, charthick = 3                                                                                                               "
			printf, lun, "				xyouts, -205.0, 0.10, local_redshift_label, charsize = 1.3, charthick = 3                                                                                                        "
			printf, lun, "                                                                                                                                                                                               "
			...
			printf, lun, "				minus_plus_index = $                                                                                                                                                             "
			printf, lun, "				where(plot_lambda ge local_lambda*(z_arr[i] + 1.0) - 100.0 and plot_lambda lt local_lambda*(z_arr[i] + 1.0)  + 100)                                                              "
			printf, lun, "		                                                                                                                                                                                         "
			...
			printf, lun, "					                                                                                                                                                                             "
			printf, lun, "				                                                                                                                                                                                 "
			printf, lun, "if local_element  eq plot_element[minus_plus_index[z]] then color_code = 50 "
			printf, lun, "				                                                                                                                                                                                 "
			...
			printf, lun, "				                                                                                                                                                                                 "
			printf, lun, "				                                                                                                                                                                                 "
			printf, lun, "					if element_velocity_location gt -280.0 and element_velocity_location lt 790.0 then begin                                                                                     "
			printf, lun, "					                                                                                                                                                                             "
			...
			printf, lun, "							xyouts, element_velocity_location + 9.0, 1.25, label, orientation = 90, $                                                                                            "
			printf, lun, "								    color=color_code, charthick = 2, charsize = 0.7                                                                                                              "
			printf, lun, "                                                                                                                                                                                               "
			printf, lun, "					endif                                                                                                                                                                        "
			printf, lun, "					                                                                                                                                                                             "
	...
	pro_name = pro_path + "panel_plot_" + id + ".pro"	
	shell_name = shell_path + "panel_plot_" + id + ".sh"	
